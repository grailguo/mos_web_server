# Generated by Django 3.2.13 on 2022-07-01 02:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='erecto.source')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('compound', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accio.compound')),
                ('experiment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accio.experiment')),
                ('method_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='erecto.methodtype')),
                ('organization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.organization')),
                ('spectrum_tag', models.ManyToManyField(to='accio.SpectrumTag')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('in_std_spectrum', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='in_std_spectrum', to='accio.spectrum')),
                ('organization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.organization')),
                ('target_spectrum', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='target_spectrum', to='accio.spectrum')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('analysis_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='erecto.analysistype')),
                ('compound', sortedm2m.fields.SortedManyToManyField(blank=True, help_text=None, to='accio.Compound')),
                ('compound_tag', models.ManyToManyField(blank=True, to='accio.CompoundTag')),
                ('organization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='users.organization')),
                ('quant_method', sortedm2m.fields.SortedManyToManyField(blank=True, help_text=None, to='accio.QuantMethod')),
                ('source', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='erecto.source')),
            ],
            options={
