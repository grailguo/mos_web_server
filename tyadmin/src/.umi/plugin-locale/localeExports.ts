...
import {
  ...
  IntlShape,
  MessageDescriptor,
} from 'D:/workspace/data_platform/github/mos_web_server/tyadmin/node_modules/react-intl';
import { ApplyPluginsType } from 'umi';
import { event, LANG_CHANGE_EVENT } from './locale';
// @ts-ignore
import warning from 'D:/workspace/data_platform/github/mos_web_server/tyadmin/node_modules/warning/warning.js';

import { plugin } from '../core/umiExports';

export * from 'D:/workspace/data_platform/github/mos_web_server/tyadmin/node_modules/react-intl';
...
export const localeInfo: {[key: string]: any} = {
  'en-US': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('D:/workspace/data_platform/github/mos_web_server/tyadmin/src/locales/en-US.js')),
    },
    locale: 'en-US',
    antd: {
  ...
  'zh-CN': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('D:/workspace/data_platform/github/mos_web_server/tyadmin/src/locales/zh-CN.js')),
    },
    locale: 'zh-CN',
    antd: {
